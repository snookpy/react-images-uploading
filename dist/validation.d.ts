...
export declare const isMinFileSizeValid: (fileSize: any, minFileSize?: any) => boolean;
...
export declare const getErrorValidation: ({ fileList, value, maxNumber, keyUpdate, acceptType, maxFileSize, minFileSize, resolutionType, resolutionWidth, resolutionHeight, allowNonImageType, }: {
    fileList: any;
    value: any;
    maxNumber: any;
    keyUpdate: any;
